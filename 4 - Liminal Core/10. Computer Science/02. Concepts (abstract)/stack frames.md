...
Stack: [[4 - Liminal Core/10. Computer Science/02. Concepts (abstract)/stack]]
ESP: [[4 - Liminal Core/10. Computer Science/02. Concepts (abstract)/ESP]] 
EBP: [[4 - Liminal Core/10. Computer Science/02. Concepts (abstract)/EBP]] 
Registries: [[4 - Liminal Core/10. Computer Science/02. Concepts (abstract)/registry]] 