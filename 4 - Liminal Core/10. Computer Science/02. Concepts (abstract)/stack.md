...
HINT: Can store multiple different data types, unlike [[4 - Liminal Core/10. Computer Science/02. Concepts (abstract)/array]]
...
Topic: [[4 - Liminal Core/10. Computer Science/02. Concepts (abstract)/linear data structures]] 
Important: [[abstract data type 1]] 
